...
// Correct form nesting: __proto__[role]=admin
// Registration doesn't block __proto__ because no res parameter is passed to merge!
// This is 100% correct now!
...
console.log("Sending form-data with __proto__.role = admin...");
